...
const getIcon = (props: PropTypes) => {
  ...
  if(name === 'search') {
    return (<svg {...rest} height={typeof height === "number" ? height : (25 || size || 0)} width={typeof width === "number" ? width : (26 || size || 0)} onClick={onClick} style={style} className={className} fill={color} viewBox="0 0 26 25"><path fillRule="evenodd" clipRule="evenodd" d="M17.362 17.07A9.5 9.5 0 1 1 20 10.5a9.46 9.46 0 0 1-1.983 5.81l-.053-.053-.707.707.105.106zm.708.707A10.47 10.47 0 0 1 10.5 21C4.701 21 0 16.299 0 10.5S4.701 0 10.5 0 21 4.701 21 10.5c0 2.465-.85 4.73-2.27 6.522l7.013 7.014-.707.707-6.966-6.966z" /></svg>);
  }
